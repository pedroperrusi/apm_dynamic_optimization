...
m = GEKKO()
m.options.IMODE = 2
# coefficients as fixed variables in time
c = [m.FV(value=0) for i in range(4)]  # maximum order in this example is 3
x = m.Param(value=xm)
y = m.CV(value=ym)  # Controlled variables used as setpoints for the regression
y.FSTATUS = 1
# polynomial model
